...
"""
#%%
from HirisSeqReader import Foldersearch, Seq_to_Video, QuickRegexp
...
outputBASE = r"G:\CompressionExport\BehavioralVideos"
...
try :
    ...
    TrialFileName              = "Trial" 
    inputBASE                  = r"F:\MazeWhiskerImaging\BehavioralVideos"
    outputBASE                 = r"G:\CompressionExport\BehavioralVideos"
    ...
    for root, dirs, files in os.walk(inputBASE):
        ...
        for subdir in dirs :
            ...
            for Video in ListOfFiles:      
                ...
                Status = Seq_to_Video(Video, outputSUB, output_name = Mouseno+"_"+vout_name , extension = ".avi", codec = "MJPG" )
