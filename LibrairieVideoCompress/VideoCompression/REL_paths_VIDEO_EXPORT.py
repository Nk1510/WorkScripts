...
try :
    ...
    TrialFileName              = "Trial" 
    inputBASE                  = r"F:\Acquisition_Green\BehavioralVideos"
    outputBASE                 = r"G:\Compression\BehavioralVideos"
    ...
    for root, dirs, files in os.walk(inputBASE):
        ...
        for subdir in dirs :
            ...
            for Video in ListOfFiles:      
                ...
                Status, LOG = Seq_to_Video(Video, outputSUB, output_name = Mouseno+"_"+vout_name , extension = ".avi", codec = "MJPG" )
